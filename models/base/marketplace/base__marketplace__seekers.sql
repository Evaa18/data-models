...
SELECT
    ...
    appointment_activities AS seekerdenormalized_appointment_reviews,
    time_to_job_cd AS seeker_time_to_job_cd,
    description AS seeker_description,
    graduation_year AS seeker_graduation_year,
    message_presentation_draft AS seeker_message_presentation_draft,
    message_explanation_draft AS seeker_message_explanation_draft,
