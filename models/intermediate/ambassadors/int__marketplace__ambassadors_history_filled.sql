...
WITH gap_fill_ambassadors AS (
    ...
    FROM
        GAP_FILL(
            ...
            partitioning_columns => ['ambassador_id', 'user_id', 'ambassador_classification','ambassador_company_name','company_sector_name','ambassador_job_title','address_country','address_administrative_area_level_1_region_fr','address_administrative_area_level_2_department_fr','address_city_fr', 'address_postal_code'],
            value_columns => [
